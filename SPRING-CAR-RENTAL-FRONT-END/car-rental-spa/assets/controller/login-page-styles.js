...
function updateViews(userType) {
    ...
    switch (userType) {
        case "Driver":
            ...
            $('#login-section').css('visibility','hidden');
            $('#driver-schedule').css('visibility','visible');
            $('#guest-header').css('visibility','hidden');
            $('#admin-header').css('visibility','hidden');
            $('#request-order-btn').css('visibility','hidden');break;
        case "Admin":
            $('#driver-header').css('visibility','hidden');
            $('#admin-dash-board-section').css('visibility','visible');
            $('#customer-header').css('visibility','hidden');
            $('#login-section').css('visibility','hidden');
            $('#guest-header').css('visibility','hidden');
            $('#request-order-btn').css('visibility','hidden');
        ...
        case "Customer":
            ...
            $('#request-order-btn').css('visibility','visible');
